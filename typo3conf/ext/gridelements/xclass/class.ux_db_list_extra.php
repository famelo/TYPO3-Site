...
//return jumpSelf('/typo3/mod.php?returnUrl=      &CB[el][tt_content%7C263]=1&CB[setCopyMode]=1');
//return jumpSelf('/typo3/mod.php?M=web_list&id=73&CB[el][tt_content%7C322]=1&CB[setCopyMode]=1');
